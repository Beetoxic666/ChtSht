<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["aksi"])) {
            ...
            if ($aksi == "tambah") {
                $query = "INSERT INTO penduduk (nama, rt, jenis_kelamin) VALUES ('$nama', '$rt', '$jenis_kelamin')";
            } elseif ($aksi == "edit" && $id) {
                $query = "UPDATE penduduk SET nama='$nama', rt='$rt', jenis_kelamin='$jenis_kelamin' WHERE id='$id'";
            ...
            if (isset($query)) {
                ...
                header("Location: penduduk_desa.php?page=penduduk_desa");
                exit;
            }
        }
    }
                        ...
                        <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1" aria-labelledby="modalEditLabel<?= $row['id'] ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <form method="POST">
                                    ...
                                    <h5 class="modal-title" id="modalEditLabel<?= $row['id'] ?>">Edit Penduduk</h5>
                        ...
                        <div class="modal fade" id="modalDelete<?= $row['id'] ?>" tabindex="-1" aria-labelledby="modalDeleteLabel<?= $row['id'] ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <form method="POST">
                                    ...
                                    <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                    <div class="modal-header">
                                    <h5 class="modal-title" id="modalDeleteLabel<?= $row['id'] ?>">Hapus Penduduk</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                    </div>
                                    <div class="modal-body">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form method="POST">
                ...
                <div class="modal-header">
                <h5 class="modal-title" id="modalTambahLabel">Tambah Penduduk</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body">
                <div class="mb-3">
